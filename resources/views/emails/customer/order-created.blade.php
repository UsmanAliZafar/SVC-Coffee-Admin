{{-- Path: resources/views/emails/customers/order-received.blade.php --}}
...
@php
    ...
    $headerSubtitle     = "We've received your order";
    $headerStyle        = 'green';
    $footerSupportText  = 'Questions about your order?';
@endphp

@section('email_title', 'Order Received')
...
@section('email_content')
    ...
    <p style="font-size: 16px; color: #666; line-height: 1.8; margin-bottom: 25px;">
        ...
        We'll send you another email once your order has been confirmed and is being prepared for shipment.
    </p>
        ...
        <table style="width: 100%; border-collapse: collapse;">
            ...
            <tr style="border-top: 1px solid #dee2e6;">
                ...
                <td style="padding: 8px 0; text-align: right;">
                    <span style="display: inline-block; padding: 4px 12px; background-color: #ffc107; color: #000000; border-radius: 4px; font-size: 12px; font-weight: 600;">
                        PENDING
                    </span>
                </td>
            </tr>
